...
![_config.yml](/images/policy_15x15_view3x3_5p_10f_65ms_443x500.gif)


**The Environment**

<div class="imgcap">
<img src="/images/magic_rl_p1_image1.png" width="350">
...
<div class="imgcap">
<img src="/images/local_state.png" width="400">
...
<div class="imgcap">
<img src="/images/rl_flow.png" width="400">
...
<div class="imgcap">
<img src="/images/policy_6x6_view3x3_1p_2f_150ms_178x200.gif" width="400">
...
<div class="imgcap">
<img src="/images/optimal_policy_probs.png" width="400">
...
![_config.yml](/images/policy_heatmap_1.png) 
...
![_config.yml](/images/policy_6x6_view3x3_1p_2f_150ms_178x200(3).gif)

As shown, with the same policy trained in the 6x6 world, the agent cannot reach some middle cells in the 15x15 world. Let us have a look at the heatmap in the 15x15 world too (the 5 agents were placed for just the sake of animation).

![_config.yml](/images/policy_heatmap_2.png)
