...
<div class="imgcap">
<img src="/images/local_state.png" width="800">
...
<div class="imgcap">
<img src="/images/policy_heatmap_1.png" width="800">
<div class="thecap">The percentage (in %) of each map cell being met by the agent.</div>
</div>
...
<div class="imgcap">
<img src="/images/policy_heatmap_2.png" width="800">
<div class="thecap">Testing the agents using the same trained policy on the 15x15 world (the policy was trained on a 6x6 world by 1 agent). Multiple agents are inserted into the map for the sake of presentation. </div>
</div>
