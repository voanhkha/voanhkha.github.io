...
Those demonstrations demonstrate that chasing and isolating a single enemy ship is not as simple as we can think. It requires some analytical problem solving skills. If you're interested in these kinds of in-depth tactics, I recommend to read my technically detailed write-up on Kaggle (link posted at the beginning section of this post).
...
Wanna dig deep into details about how to train the model? Don't hesitate to view my technically-deep write-up on Kaggle [here]
...
Let us take a look at how the ML bot plays. The below figures show some stats of our top ML bot as compared to other top teams that we imitate from. 
