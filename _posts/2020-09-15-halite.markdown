...
<div class="Two base protecting tactics."></div>
</div>
...
<div class="High summary of a machine learning bot."></div>
</div>
...
<div class="How semantic segmentation in computer vision relates to multi-agent learning. Part of the figure is extracted from www.jeremyjordan.me/semantic-segmentation"></div>
</div>
...
<div class="Visualization of some feature layers (100 first steps)"></div>
</div>
...
<div class="Some stats during 400 game steps, averaged on all games of top competitors"></div>
</div>
...
<div class="Stats of a specific match"></div>
</div>
...
<div class="Stats of another match"></div>
</div>
