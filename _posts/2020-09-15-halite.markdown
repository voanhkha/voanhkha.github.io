...
layout: post
comments: true
title: Imitation Learning by Semantic Segmentation for Multi-Agent Halite IV Competition
excerpt: "I will show how a data-driven approach can mimic behaviours of other bots that are extremely hard to code."
mathjax: true
---

[Our full code repository (to be updated)]()

[Our Kaggle write-up (similar to this post, but with Kaggle community comments) (to be updated)]()


**Introduction**

In September 2020, I and my team, named "KhaVo Dan Gilles Robga Tung", finished high (rank 8/1140) in a world-class AI programming challenge ["Halite by Two Sigma" held on Kaggle](https://www.kaggle.com/c/halite/leaderboard).
...
<div class="imgcap">
<img src="/images/halite_team.png" width="600">
<div class="thecap">Competition result (temporary, to be updated as the ranking will be finalized on Sep 23rd 2020.</div>
</div>
...
The general framework above has a lot of customized tricks and tunes. Right now, we are working on the following ideas:
...
Feature engineering efforts were minimal. Except some basic game feature layers such as ships/bases positions, cell halites, ..., we also hand-crafted some informative features such as dominance map, threat estimation, last action, ... The features are detailedly shown as belows, with embeded data augmentation explained where due.
...
- Map halite (1 layer)
- Game step (1 layer, all pixels same value of normalized game step)
...
<div class="thecap">How semantic segmentation in computer vision relates to multi-agent learning. Part of the figure is extracted from [here](https://www.jeremyjordan.me/semantic-segmentation/) </div>
</div>
...
- Our manual bot cannot cope with the ML bot in terms of mining efficiency by a mile, but its versatality in attacking is outstanding since we can adaptively adjust the number of empty ships at various stages of the game based on different situations.

Now, let's have a look at some specific one game.
<div class="imgcap">
<img src="/images/gamestats1.png" width="600">
