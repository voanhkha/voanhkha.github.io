...
layout: post
comments: true
title: (Rank 8/1140) Imitation learning by U-Net for a multi-player strategic game
excerpt: "I will show how a data-driven approach (semantic segmentation) can mimic rule-based top bots in the Kaggle 4-Agent Halite IV Competition!"
mathjax: true
...
preview_media: /assets/previews/halite.webm
